...
pub fn build(b: *std.Build) void {
    ...
    const run_chmod_step = if (host_target.result.isDarwin()) steps: {
        ...
        chmod_exe.step.max_rss = 265_797_632;
    ...
    const build_cc_stage2_step = if (b.option(
        ...
        build_stage3.step.max_rss = 540_352_512;
...

    {
        ...
        if (binaryen_lazy_dep) |binaryen_dep| {
            ...
            update_zig1.step.max_rss = 1_707_835_392;
            ...
            build_updated_stage4.step.max_rss = 4_330_487_808;
        ...
        msvc: {
            ...
            build_msvc_compiler_rt.step.max_rss = 214_147_072;
            ...
            run_msvc_tests.step.max_rss = 6_545_408;
