...
pub extern "c" fn mmap64(addr: ?*align(std.heap.page_size) anyopaque, len: usize, prot: c_uint, flags: c_uint, fd: fd_t, offset: i64) *anyopaque;
...
pub extern "c" fn mincore(
    addr: *align(std.heap.page_size) anyopaque,
    length: usize,
    vec: [*]u8,
) c_int;
