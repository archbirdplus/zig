...
pub const ElfModule = struct {
    base_address: usize,
    dwarf: Dwarf,
    mapped_memory: []align(std.heap.page_alignment) const u8,
    external_mapped_memory: ?[]align(std.heap.page_alignment) const u8,
    ...
    pub fn load(
        gpa: Allocator,
        mapped_mem: []align(std.heap.page_alignment) const u8,
        build_id: ?[]const u8,
        expected_crc: ?u32,
        parent_sections: *Dwarf.SectionArray,
        parent_mapped_mem: ?[]align(std.heap.page_alignment) const u8,
