...
pub const SubmissionQueue = struct {
    ...
    mmap: []align(heap.page_alignment) u8,
    mmap_sqes: []align(heap.page_alignment) u8,
...
pub const BufferGroup = struct {
    ...
    br: *align(heap.page_alignment) linux.io_uring_buf_ring,
...
pub fn setup_buf_ring(fd: posix.fd_t, entries: u16, group_id: u16) !*align(heap.page_alignment) linux.io_uring_buf_ring {
    ...
    const br: *align(heap.page_alignment) linux.io_uring_buf_ring = @ptrCast(mmap.ptr);
...
pub fn free_buf_ring(fd: posix.fd_t, br: *align(heap.page_alignment) linux.io_uring_buf_ring, entries: u32, group_id: u16) void {
    unregister_buf_ring(fd, group_id) catch {};
    var mmap: []align(heap.page_alignment) u8 = undefined;
    mmap.ptr = @ptrCast(br);
