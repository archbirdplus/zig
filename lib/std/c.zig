...
pub extern "c" fn mmap64(addr: ?*align(page_alignment) anyopaque, len: usize, prot: c_uint, flags: c_uint, fd: fd_t, offset: i64) *anyopaque;
...
pub extern "c" fn mincore(
    addr: *align(page_alignment) anyopaque,
    length: usize,
    vec: [*]u8,
) c_int;
...
pub extern "c" fn mmap(addr: ?*align(page_alignment) anyopaque, len: usize, prot: c_uint, flags: MAP, fd: fd_t, offset: off_t) *anyopaque;
pub extern "c" fn munmap(addr: *align(page_alignment) const anyopaque, len: usize) c_int;
pub extern "c" fn mprotect(addr: *align(page_alignment) anyopaque, len: usize, prot: c_uint) c_int;
...
const private = struct {
    ...
    extern "c" fn msync(addr: *align(page_alignment) const anyopaque, len: usize, flags: c_int) c_int;
    ...
    extern "c" fn __msync13(addr: *align(page_alignment) const anyopaque, len: usize, flags: c_int) c_int;
